...
public class CommentController {
    ...
    public ResponseEntity<String> modify(@PathVariable int comment_Id, @RequestBody CommentDto commentDto, HttpSession session) {
    ...
    public ResponseEntity<String> write(@RequestBody CommentDto commentDto, int board_Id, HttpSession session
                                        ) {

        if(Integer.valueOf(commentDto.getParentComment_Id())==null)
    ...
    public ResponseEntity<String> remove(@PathVariable int comment_Id, int board_Id, HttpSession session, CommentDto commentDto){
        String comment_Writer = (String)session.getAttribute("nickName");
        try {
    ...
    @GetMapping("/comments")
    public ResponseEntity<List<CommentDto>> list(int board_Id){
